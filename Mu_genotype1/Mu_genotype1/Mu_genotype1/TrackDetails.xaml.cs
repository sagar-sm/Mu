...
namespace Mu_genotype1
{
    ...
    /// </summary>
    public sealed partial class TrackDetails : Mu_genotype1.Common.LayoutAwarePage
    {
        public TrackDetails()
        {
        ...
        protected override void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            itemListView.ItemsSource = Globalv.RecommendedTracks;
        ...
        async void ItemListView_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {
            ...
            try
            {
                using (XmlReader rd = XmlReader.Create(new StringReader(resp)))
                {
                    ...
                    SongContentTb.Text = content;
                }
            }
            catch (Exception) { SongContentTb.Text = "Additional information is currently unavailable."; }
            progbar.Visibility = Visibility.Collapsed;
        }
