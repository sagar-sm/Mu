...
namespace Mu_genotype1
{
    ...
    public sealed partial class Tweet : Mu_genotype1.Common.LayoutAwarePage
    {
        ...
        private async void TwitterConnectBtn_Click_1(object sender, RoutedEventArgs e)
        {
            try
            {
                Globalv.TwitterAccessToken = await Twitter.Rcv_Request_token();

                ////////////////////////////////////////////////

                HttpClient cli2 = new HttpClient();
                string auth_url = @"https://api.twitter.com/oauth/authenticate?oauth_token=" + Globalv.TwitterAccessToken.Token;

                var success = await Windows.System.Launcher.LaunchUriAsync(new Uri(auth_url));
        ...
        private async void VerifyPinBtn_Click_1(object sender, RoutedEventArgs e)
        {
            OAuthToken at = await Twitter.ExchangeRequestWithAccessToken(Globalv.TwitterAccessToken, PinTb.Text);
